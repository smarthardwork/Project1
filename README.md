...
This playbook is for setting up version 5.x of the ELK Stack on a local server. 

## Notes and requirements

 - The playbook was built and tested on Ubuntu 14.04 VMs, for ELK versions 5.x 
